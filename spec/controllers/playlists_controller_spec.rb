...
describe "POST #create" do
  context "with valid params" do
    it "creates an playlist and renders the playlist show page" do
      expect {
  ...
  describe "PUT #update" do
    context "with valid params" do
      it "updates an playlist and renders the index page" do
        playlist = create(:playlist)
        put :update, {:id => playlist.to_param, :playlist => attributes_for(:playlist, name: "New Jams")}
        playlist.reload
        expect(playlist.name).to eq("New Jams")
      end
